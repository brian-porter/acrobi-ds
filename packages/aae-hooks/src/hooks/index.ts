...
// AAE Display - using PWA Display hook instead
export { usePWADisplay as useAAEDisplay } from './use-pwa-display';
export type {
  PWADisplayMode as AAEDisplayMode,
  UsePWADisplayReturn as UseAAEDisplayReturn,
} from './use-pwa-display';
