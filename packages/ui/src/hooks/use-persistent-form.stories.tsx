    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      {!form.isSupported && (
        <div style={{ 
          ...
          ⚠️ LocalStorage is not supported, form data will not be persisted
        </div>
      )}
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '15px' }}>
            <div style={{ 
              ...
              {form.isAutoSaving ? '💾 Auto-saving...' : 
               form.isSaved ? '✅ Saved' : 
               form.isDirty ? '⚠️ Unsaved changes' : '📝 Ready'}
            </div>
          </div>
      ...
      <div style={{ marginBottom: '30px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
          ...
          <span style={{ fontSize: '12px', color: '#666' }}>
            {form.isAutoSaving ? '💾 Auto-saving...' : form.isSaved ? '✅ Saved' : '⚠️ Unsaved'}
          </span>
        </div>
