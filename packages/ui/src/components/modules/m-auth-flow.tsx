...
import { SAuthCreateAccount, type AuthCreateAccountData } from '../structures/s-auth-create-account';
import { SAuthVerifyContact, type AuthVerifyContactData } from '../structures/s-auth-verify-contact';
import { SAuthFork, type AuthForkData, type AuthForkPath } from '../structures/s-auth-fork';
import { SAuthHandle, type AuthHandleData } from '../structures/s-auth-handle';
import { SAuthAddSecondaryContact } from '../structures/s-auth-add-secondary-contact';
import { SAuthPasskey } from '../structures/s-auth-passkey';
import { SAuthConnectSocials } from '../structures/s-auth-connect-socials';
import { SAuthSetFavorites } from '../structures/s-auth-set-favorites';
