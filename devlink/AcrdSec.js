...
import _styles from "./AcrdSec.module.css";
...
export function AcrdSec({
  ...
  return acrdSec ? (
    <_Component
      className={_utils.cx(_styles, "acrd-sec_main")}
      tag="div"
      fs-accordion-element="accordion"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "acrd-sec-trig")}
        tag="div"
        tabIndex="0"
        role="button"
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "acrd-sec-body")}
        tag="div"
        id="acc-content-2"
      >
